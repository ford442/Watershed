...
async function run() {
  ...
  await page.addStyleTag({ content: 'canvas { background-color: #000 !important; } body { background-color: #000 !important; }' });
  ...
  await page.screenshot({ path: '/content/watershed/screenshot_blackbg.png', fullPage: false });
  console.log('Saved screenshot_blackbg.png');
  await browser.close();
}
