...
const createWingGeometry = (side: number, config: WingGeometryConfig): THREE.BufferGeometry => {
...
export default function Birds({ transforms, birdType = 'songbird', isNight = false }: BirdsProps) {
  ...
  useFrame(({ clock, camera }) => {
   ...
   birds.forEach((bird, index) => {
     ...
     bodyMesh.setMatrixAt(index, DUMMY_OBJ.matrix);
     ...
     DUMMY_OBJ.scale.setScalar(bird.scale);
     DUMMY_OBJ.updateMatrix();
     leftWingMesh.setMatrixAt(index, DUMMY_OBJ.matrix);
     ...
     DUMMY_OBJ.scale.setScalar(bird.scale);
     DUMMY_OBJ.updateMatrix();
     rightWingMesh.setMatrixAt(index, DUMMY_OBJ.matrix);
   });
