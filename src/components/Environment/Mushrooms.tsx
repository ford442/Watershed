...
type CapType = 'button' | 'table' | 'young';
...
const CAP_TYPES: readonly CapType[] = ['button', 'table', 'young'];
...
interface MushroomInstanceData {
    key: string;
...
type InstancesByCap = Record<CapType, MushroomInstanceData[]>;

export default function Mushrooms({ transforms, biome = 'canyonSummer' }: MushroomsProps) {
    ...
    const instancesByCap = useMemo<InstancesByCap>(() => {
        const grouped: InstancesByCap = { button: [], table: [], young: [] };
