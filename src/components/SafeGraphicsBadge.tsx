...
const REASON_COPY: Record<GraphicsCapabilityReason, string> = {
  ...
  'previous-boot-failed':
    'The previous start never reached a steady frame rate, so this one began in safe mode at Low quality. Raise it again in Options — if the next start is healthy, the clamp lifts on its own.',
