...
describe('boot-crash guard', () => {
  it('clamps quality to low after a boot that never reached a steady frame rate', async () => {
    useSettingsStore.setState({ quality: 'med', _hasHydrated: true });
    render(<App graphicsBoot={bootFor('degraded', { reason: 'previous-boot-failed' }, true)} />);
